        ...
        for (const external of mainstay.externals) {
            ...
            try {
                ...
                if (output instanceof Errors.Report) {
                    ...
                    errors.push(output);
                    console.log(settings.abortEarly, 'settings.abortEarly 114')
                ...
                if (Array.isArray(output) &&
                    ...
                    console.log(settings.abortEarly, 'settings.abortEarly 127')
                    if (settings.abortEarly) {
                        break;
                    }
...
exports.validate = function (value, schema, state, prefs, overrides = {}) {
    ...
    if (schema._valids) {
        ...
        if (schema._flags.only) {
            ...
            console.log(settings.abortEarly, 'settings.abortEarly 398')
            if (prefs.abortEarly) {
    ...
    if (schema._invalids) {
        ...
        if (match) {
            ...
            console.log(settings.abortEarly, 'settings.abortEarly 415')
            if (prefs.abortEarly) {
                return internals.finalize(value, [report], helpers);
            }
