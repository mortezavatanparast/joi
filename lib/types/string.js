...
module.exports = Any.extend({
    ...
    messages: {
        'string.alphanum': '{ {{#label}}: "invalid"}',
        'string.base': '{ {{#label}}: "invalid"}',
        'string.base64': '{ {{#label}}: "invalid"}',
        'string.creditCard': '{ {{#label}}: "invalid"}',
        'string.dataUri': '{ {{#label}}: "invalid"}',
        'string.domain': '{ {{#label}}: "invalid"}',
        'string.email': '{ {{#label}}: "invalid"}',
        'string.guid': '{ {{#label}}: "invalid"}',
        'string.hex': '{ {{#label}}: "invalid"}',
        'string.hexAlign': '{ {{#label}}: "invalid"}',
        'string.hostname': '{ {{#label}}: "invalid"}',
        'string.ip': '{ {{#label}}: "invalid"}',
        'string.ipVersion': '{ {{#label}}: "invalid"}',
        'string.isoDate': '{ {{#label}}: "invalid"}',
        'string.isoDuration': '{ {{#label}}: "invalid"}',
        'string.empty': '{ {{#label}}: "required"}',
        'string.length': '{ {{#label}}: "length:{{#limit}}"}',
        'string.lowercase': '{ {{#label}}: "invalid"}',
        'string.max': '{ {{#label}}: "max:{{#limit}}"}',
        'string.min': '{ {{#label}}: "min:{{#limit}}"}',
        'string.normalize': '{ {{#label}}: "invalid"}',
        'string.token': '{ {{#label}}: "invalid"}',
        'string.pattern.base': '{ {{#label}}: "pattern:{{#regex}}"}',
        'string.pattern.name': '{ {{#label}}: "pattern:{{#name}}"}',
        'string.pattern.invert.base': '{ {{#label}}: "pattern:{{#regex}}"}',
        'string.pattern.invert.name': '{ {{#label}}: "pattern:{{#name}}"}',
        'string.trim': '{ {{#label}}: "invalid"}',
        'string.uri': '{ {{#label}}: "invalid"}',
        'string.uriCustomScheme': '{ {{#label}}: "invalid"}',
        'string.uriRelativeOnly': '{ {{#label}}: "invalid"}',
        'string.uppercase': '{ {{#label}}: "invalid"}',
    }
});
