...
module.exports = Any.extend({
    ...
    messages: {
        'number.base': '{ {{#label}}: "invalid"}',
        'number.infinity': '{ {{#label}}: "invalid"}',
        'number.integer': '{ {{#label}}: "invalid"}',
        'number.greater': '{ {{#label}}: "greater:{{:#limit}}"}',
        'number.less': '{ {{#label}}: "less:{{:#limit}}"}',
        'number.max': '{ {{#label}}: "max:{{:#limit}}"}',
        'number.min': '{ {{#label}}: "min:{{:#limit}}"}',
        'number.multiple': '{ {{#label}}: "multiple:{{:#multiple}}"}',
        'number.negative': '{ {{#label}}: "min:{{:#limit}}"}',
        'number.port': '{ {{#label}}: "min:{{:#limit}}"}',
        'number.positive': '{ {{#label}}: "min:{{:#limit}}"}',
        'number.precision': '{ {{#label}}: "min:{{:#limit}}"}',
        'number.unsafe': '{ {{#label}}: "min:{{:#limit}}"}',
    }
});
